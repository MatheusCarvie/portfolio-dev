...
const Hero = () => {
  ...
  return (
    <section className="h-auto flex items-center justify-center relative overflow-hidden bg-gradient-subtle mt-10">
      {/* Gradient Orbs */}
      ...
      <div className="container mx-auto px-4 z-10 py-0">
        <div className="text-center max-w-5xl mx-auto">
          ...
          {/* CTA Buttons */}
          <div
            className="flex flex-wrap gap-4 justify-center mb-16 animate-fade-in max-sm:flex-col px-4"
